...
var conpas = document.getElementById("confirm-password");

function Error(){
	var conpas = document.getElementById("confirm-password").value;
	var pas = document.getElementById("password").value;
	if(conpas!=pas){
	document.getElementById("error").style.color="red";
	document.getElementById("error").innerHTML = "Password doesn't match"	;
	document.getElementById("error").style.marginLeft="10px";
